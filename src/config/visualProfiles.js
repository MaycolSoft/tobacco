...
export const visualProfiles = {
  ...
  black: profile('black', 'Black', 'Pure black with neutral, monochrome detailing.',
    ['Black', 'Minimal', 'Precise', 'Contemporary'], 'reserve',
    ['#C8C8C8', '#000000', '#080808', '#101010', '#F2F2F2', '#B8B8B8', '#929292', '#E8E8E8', '#B8B8B8', '#C8C8C8', '#D6C8B9']),
