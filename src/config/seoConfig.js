...
export const seoRoutes = {
  ...
  '/about': { title: 'El oficio | Tabacalera Tamboril', description: 'Conoce el oficio del tabaquero y su proceso: selección, composición y elaboración de cada cigarro.', label: 'El oficio', language: 'es', index: true },
  ...
  '/craft-your-cigar': { title: 'Crear mi cigarro | Tabacalera Tamboril', description: 'Explora las hojas, combina capa, capote y tripa y descubre visualmente la formación de un cigarro.', label: 'Crear mi cigarro', language: 'es', index: false },
};
