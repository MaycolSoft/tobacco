...
const sections = [
  { id: 'guide-composition', label: 'Cómo se compone', Icon: Layers },
  { id: 'guide-families', label: 'Cómo se expresan', Icon: BookOpen },
  { id: 'guide-collection', label: 'Explora las hojas', Icon: Leaf },
];
const recipe = {
  ...
  return createPortal(
    <div className="tg-experience" ref={dialogRef} role="dialog" aria-modal="true" aria-labelledby="tg-title">
      <header className="tg-header">
        ...
        <span className="tg-brand">Guía de la mezcla <span>/ Mesa de composición</span></span>
      ...
      <div className="tg-scroll" ref={scrollRef} onScroll={updateSection} tabIndex={0} role="region" aria-label="Contenido de la guía">
        <div className="tg-content">
          ...
          <section id="guide-composition" className="tg-section" aria-labelledby="tg-composition-title">
            <div className="tg-section-heading"><span className="tg-section-number">01</span><div><span className="tg-eyebrow">Cómo se compone</span><h2 id="tg-composition-title">De dentro hacia fuera.</h2></div></div>
          ...
          <section id="guide-families" className="tg-section" aria-labelledby="tg-families-title">
            <div className="tg-section-heading"><span className="tg-section-number">02</span><div><span className="tg-eyebrow">Cómo se expresan</span><h2 id="tg-families-title">Diferentes expresiones.</h2></div></div>
            <TobaccoFamiliesInfo />
          </section>
          <section id="guide-collection" className="tg-section" aria-labelledby="tg-collection-title">
            <div className="tg-section-heading"><span className="tg-section-number">03</span><div><span className="tg-eyebrow">Explora las hojas</span><h2 id="tg-collection-title">Ahora, conoce las hojas.</h2></div></div>
            <TobaccoFamilyGallery />
            <Link className="tg-library-link" to="/leaf-library">Explorar la colección completa <ArrowRight size={17} /></Link>
          </section>
          <p className="tg-end-note">Cada hoja aporta una parte. La mezcla cuenta la historia.</p>
        </div>
      </div>
      <footer className="tg-footer"><span>Tu mezcla se conserva al cerrar la guía.</span><button onClick={onClose}>Continuar mi mezcla <ArrowRight size={17} /></button></footer>
    </div>, document.body,
  );
}
