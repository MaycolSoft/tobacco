        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-4 py-0 py-lg-5">
              ...
              <button className="btn btn-secondary font-weight-bold py-2 px-4 mt-2">
                Learn More
              </button>
            </div>
            ...
            <div className="col-lg-4 py-0 py-lg-5">
              ...
              <button className="btn btn-primary font-weight-bold py-2 px-4 mt-2">
                Learn More
              </button>
            </div>
          </div>
